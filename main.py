...
app = Flask(__name__)
app.config['SECRET_KEY'] =  os.environ['FLASK_KEY']#"8BYkEfBA6O6donzWlSihBXox7C0sKR6b"
...
class Base(DeclarativeBase):
    pass
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ['SQL_CONFIG']#'sqlite:///posts.db'
...
MAIL_APP_PW = (os.environ["EMAIL_PASSWORD"])
